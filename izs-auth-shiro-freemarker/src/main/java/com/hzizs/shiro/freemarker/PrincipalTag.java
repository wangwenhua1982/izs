package com.hzizs.shiro.freemarker;
 ...
 * </p>
 * <p>
 * If no attributes are specified, the tag prints out the <tt>toString()</tt> value of the user's default principal. If the <tt>type</tt> attribute is specified, the tag looks for a principal with the given type. If the <tt>property</tt> attribute is specified, the tag prints the string value of the
 * specified property of the principal. If no principal is found or the user is not authenticated, the tag displays nothing unless a <tt>defaultValue</tt> is specified.
 * </p>
 * <p>
