 ...
 * <p>
 * <b>Note:</b> This is <em>less</em> restrictive than the <code>AuthenticatedTag</code> since it only assumes the user is who they say they are, either via a current session login <em>or</em> via Remember Me services, which makes no guarantee the user is who they say they are. The
 * <code>AuthenticatedTag</code> however guarantees that the current user has logged in <em>during their current session</em>, proving they really are who they say they are.
 * <p>
